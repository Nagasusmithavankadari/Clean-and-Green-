...
public class send_to_mail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_send_to_mail);
    ...
    View.OnClickListener buttonSelectImageOnClickListener
    ...
    View.OnClickListener buttonSendEmail_intentOnClickListener
            = new View.OnClickListener(){
